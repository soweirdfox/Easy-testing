                ...
                <table>
                    <thead className="results-tb-head">
                        <tr className="results-tr">
                            ...
                            <th className="th-results">Init By</th>
                        ...
                        {resultsData.map((resultData) => {
                            return (
                                <tr className="results-tb-tr-body" key={resultData.RowKey}>
                                    ...
                                    <td className="td-results">{<Button btnName="Detail" color="var(--light-color)" onClick={() => navigate('/SST/details')} />}</td>
                                    <td className="td-results">{<Button btnName="Delete" color="var(--logo-color)" onClick={() => deleteResult(resultData.RowKey)} />}</td>
                                </tr>
                            )
                        })}
                    </tbody>
...
export default SmokeTestResultsPage;