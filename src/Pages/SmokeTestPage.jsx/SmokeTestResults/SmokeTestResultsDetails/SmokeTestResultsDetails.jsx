...
function SmokeTestResultsDetails() {
    const date = new Date();
    const resultsData = [
        {
            id: 1,
    ...
    return (
        <div className="detailsSST-container">
            ...
            <div className="detailsSST-text-area">
                ...
                <p className="dtl-p">Errors Count: {resultDetails.errorCount}</p>
                <p className="dtl-p">Warnings Count: {resultDetails.warningsCount}</p>
                <p className="dtl-p">Passed: {resultDetails.status}</p>
                <p className="dtl-p">Init By: {resultDetails.initBy}</p>
...
export default SmokeTestResultsDetails;